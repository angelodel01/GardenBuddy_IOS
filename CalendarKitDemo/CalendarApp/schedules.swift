...
class Schedule{
    ...
    static var Display: [String: [EventDescriptor]]?
//    static let numToDay = [
//        1: "mon",
//        2: "tue",
//        3: "wed",
...
//    ]
    ...
    func translateToDisplay(_ date: Date)-> [EventDescriptor]{
        ...
        print("             ANGELOS WEEKDAY : \(String(describing: weekday))")
        var disp_events = [Event]()
        let day = getDay(day: weekday)
        for curr in day{
            //each curr is a GB_Event
            let new:Event = Event();
            print("             CURR zone_num: \(curr.zone_num)")
...
func processResp(resp: [String: [[String: Any]]]){
     ...
     Schedule.Display = [String: [EventDescriptor]]()
 }
